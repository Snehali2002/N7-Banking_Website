/* ============================================================
   Hero — headline, CTAs, trusted-by, and the floating mockup
   composition (photo + balance card + recent-activity card),
   matched to the reference comp. Built at native 580x432 and
   JS-scaled to fit its column.
   ============================================================ */
