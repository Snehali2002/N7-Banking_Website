/* ============================================================
   Cloud (CB7) · Efficiency checklist · CTA bands
   ============================================================ */
...
function CTABand({ id, lead = "CB7 helps your financial institution improve the client experience, automate and optimize procedures, simplify banking operations", wm = "CB7" }) {
  return (
...
Object.assign(window, { CloudSection, EfficiencySection, CTABand, CTAPlain });
