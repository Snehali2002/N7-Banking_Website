...
/* ---- icons ---- */
export function ArrowDiag({ className }) {
...
/* ---- buttons ---- */
export function PrimaryButton({ children = "REQUEST DEMO", className = "", ...p }) {
  return <button className={`btn btn-primary ${className}`} {...p}>{children}</button>;
}

export function OutlineButton({ children = "CONTACT US", light = false, className = "", ...p }) {
  return <button className={`btn btn-outline ${light ? "on-light" : ""} ${className}`} {...p}>{children}</button>;
}

export function LearnMore({ children = "learn more", ...p }) {
  return (
    <a className="learn" {...p}>
...
/* ---- check item ---- */
export function Check({ children, light = false }) {
  return (
    <div className="check">
